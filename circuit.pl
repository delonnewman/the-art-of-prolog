...
% nand_gate(Input1,Input2,Output) :- Output is the logical nand of Input1 and Input2.
...
% and_gate(Input1,Input2,Output) :- Output is the logical and of Input1 and Input2.
